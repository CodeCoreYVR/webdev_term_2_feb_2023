...
-- 2.  Select product names, product prices and the lowest price they were sold at during the last 20 months.
...
WHERE orders.completed_on >= '2016-01-01' AND orders.completed_on < '2018-03-28'
